            ...
            if not any(punct in sourceSegment.split('_')[0] for punct in ".,!?"):
                if len(sourceSegment.split('_')) == 2 and len(targetSegment.split('_')) == 2:
                    ...
                    if label == "literal":
                        ...
                        allPairs.append(pairSegment + " # " + "equivalence")
                    elif label == "lexical_shift":
                        allPairs.append(pairSegment + " # " + "lexical_shift")

                    elif label == "transposition":
                        allPairs.append(pairSegment + " # " + "transposition")
                    elif label == "generalization":
                        allPairs.append(pairSegment + " # " + "generalization")
                    elif label == "particularization":
                        allPairs.append(pairSegment + " # " + "particularization")
                    elif label == "modulation":
                        allPairs.append(pairSegment + " # " + "modulation")
                    elif label == "modulation_transposition":
                        allPairs.append(pairSegment + " # " + "modulation_transposition")
                    elif label == "figurative":
                        allPairs.append(pairSegment + " # " + "figurative")
