python3 finetune-nlTranslation.py  \
--exp_name fineTune_xlm_nlT  \
--dump_path ./dumped         \
--model_path ./models/mlm_tlm_xnli15_1024.pth  \
--data_path ../annotated-ted-talks/corpus/rosetta-testData/ \
--transfer_tasks nlT   \
--trainCorpus balanced \
--devCorpus balanced  \
--testCorpus enfr-chp1  \
--inference True     \
--resume_training False  \
--clf_result phraseLevel_clf_result.txt \
--checkpoint_dir ./phrase-finalModel  \
--bestModel balanced.final.last.pth.tar  \
--optimizer_e adam,lr=0.000055        \
--optimizer_p adam,lr=0.000055        \
