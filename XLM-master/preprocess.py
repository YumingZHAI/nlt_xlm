...
# e.g. python3 preprocess.py vocab_xnli_15 /Users/yumingzhai/PycharmProjects/Coling2020/annotated-ted-talks/corpus/sub1.en.bpe

if __name__ == '__main__':

    logger = create_logger(None, 0)

    voc_path = sys.argv[1]    # the vocab file is provided together with the model
    txt_path = sys.argv[2]
    ...
    # add [1] to [sentences] at the end of each sentence
